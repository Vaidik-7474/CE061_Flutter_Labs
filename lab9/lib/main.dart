...
*/
  List<Quote> quotes = [
    Quote(text: 'Don’t do drugs.',author:
    'CE061'),

    Quote(author: 'CE061', text: "Somewhere deep down there's a decent man in me, he just can't be found."),
    Quote(text: "I can't tell you what it really is, I can only tell you what it feels like.",author:
    'CE061'),
  ];
/*
Widget quoteTemplate(quote){
